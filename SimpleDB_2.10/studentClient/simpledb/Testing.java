 ...
 * 
 * This class is used to test the functionality of the simple database program for task 2.6 of the homework
 * It also shows the output of running these tests and total time to run all of the tests.
 * 
...
public class Testing {
	...
	public static void main(String[] args) {
		...
		try {
			...
			long totalStartTime = System.currentTimeMillis(); // Time to start testing.
			...
			long totalEndTime = System.currentTimeMillis(); // Time that testing ends.
			System.out.println("Time for all queries: " + (totalEndTime-totalStartTime) + " ms");
