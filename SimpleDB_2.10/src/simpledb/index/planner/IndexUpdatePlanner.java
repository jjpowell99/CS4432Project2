...
public class IndexUpdatePlanner implements UpdatePlanner {
   ...
   public int executeInsert(InsertData data, Transaction tx) {
      ...
      for (String fldname : data.fields()) {
         ...
         //System.out.println("Modify field " + fldname + " to val " + val); CS4432-project2 Stopped printing to expedite testing
   ...
   public int executeCreateIndex(CreateIndexData data, Transaction tx) {
	  //cs4432-project2: added index type for part 1
	  System.out.println("yeet:"+data.indexType()+" "+data.indexName()+" "+data.tableName()+" "+data.fieldName());
