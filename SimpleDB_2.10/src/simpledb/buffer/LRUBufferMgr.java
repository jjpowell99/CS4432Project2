...
class LRUBufferMgr extends AbsBufferMgr{
   ...
   private HashMap<Block, Buffer> existingBlockMap; // 4432
   ...
   private Buffer chooseUnpinnedBuffer() {
	   while(possibleBuffers.size() > 0) { // CS 4432 LRU, remove
		   if(possibleBuffers.peek().isPinned()) {
